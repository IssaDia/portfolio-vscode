...
const Buttons = () => {
  ...
  return (
    <div
      className={`flex justify-normal space-x-2 items-center cursor-pointer h-full w-full pl-1 ${
        isHovered ? "hover" : ""
      }`}
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <span className="relative inline-block bg-topbar-firstButton text-red-500 rounded-full p-1.5 phone:text-2xl">
        <span
      ...
      <span className="relative inline-block bg-topbar-thirdButton rounded-full p-1.5">
        ...
        >
          <svg height="8px" viewBox="0 0 16 16" width="8px">
